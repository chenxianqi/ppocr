...
RUN git clone https://gitee.com/wu_xiao_di/paddle-ocr.git  /PaddleOCR
WORKDIR /PaddleOCR
...
CMD ["/bin/bash","-c","hub install deploy/hubserving/ocr_system/ && hub serving start -m ocr_system  -p 9000"]